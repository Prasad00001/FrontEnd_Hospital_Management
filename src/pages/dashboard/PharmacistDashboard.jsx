...
import { Pill, AlertTriangle, CheckCircle, FileText, ArrowRight } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        {/* Fixed: Navigates to Inventory Page */}
        <Button variant="primary" onClick={() => navigate('/dashboard/pharmacy/inventory')}>
              ...
              <tr key={p.id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4">
                  {p.status === 'Pending' ? (
                    <button 
                      onClick={() => navigate('/dashboard/pharmacy/prescriptions')}
                      className="text-blue-600 border border-blue-200 px-3 py-1 rounded hover:bg-blue-50 transition-colors"
                    >
                      Process
                    </button>
                  ) : (
